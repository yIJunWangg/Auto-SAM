...
if __name__ == '__main__':
    ...
    sam_model.to(device)
    model.to(device)
    check_point=r'logs\only_VRP_0220_091933.log\best_model.pt'
    model.load_state_dict(torch.load(check_point,weights_only=True))
    check_point_sam = torch.load(r'logs\only_VRP_0220_091933.log\best_model_sam.pt',weights_only=True)
