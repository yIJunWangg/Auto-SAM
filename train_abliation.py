        ...
        if epoch < 10:  # 前8轮使用AdamW
            ...
            if optimizer_sgd is None:
                optimizer_sgd = optim.SGD([
                    {'params': model.transformer_decoder.parameters(),"lr": args.lr*0.1},
                    {'params': sam_model.fusion.parameters(), "lr": args.lr*0.1},
                    {'params': sam_model.beta, "lr": args.lr*0.1},
